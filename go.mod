...
require (
	...
	github.com/konveyor/analyzer-lsp v0.8.1-alpha.2.0.20251031010141-370b41924032
	github.com/konveyor/analyzer-lsp/external-providers/java-external-provider v0.0.0-20251031010141-370b41924032
